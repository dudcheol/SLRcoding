...
public class Board_Child_FragmentOne extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBoardList.add(new Board(null,"책1","화학의 이해(생능출판사)","새삥임 안 사면 후회함","mox","2019년 7월 7일",0L,"2019년 7월 7일",0L));
        mBoardList.add(new Board(null,"책2","물리의 이해(생능출판사)","새삥임 안 사면 후회함","fdas","2019년 7월 7일",0L,"2019년 7월 7일",0L));
        mBoardList.add(new Board(null,"책3","수학의 이해(생능출판사)","새삥임 안 사면 후회함","dfx","2019년 7월 7일",0L,"2019년 7월 7일",0L));
        mBoardList.add(new Board(null,"책4","사랑의 이해(생능출판사)","새삥임 안 사면 후회함","fdas","2019년 7월 7일",0L,"2019년 7월 7일",0L));
        mBoardList.add(new Board(null,"책5","시선의 이해(생능출판사)","새삥임 안 사면 후회함","ew","2019년 7월 7일",0L,"2019년 7월 7일",0L));
        mBoardList.add(new Board(null,"책6","연준의 이해(생능출판사)","새삥임 안 사면 후회함","xvc","2019년 7월 7일",0L,"2019년 7월 7일",0L));
        mBoardList.add(new Board(null,"책7","정찬의 이해(생능출판사)","새삥임 안 사면 후회함","vcx","2019년 7월 7일",0L,"2019년 7월 7일",0L));
