                ...
                for(DocumentChange dc : queryDocumentSnapshots.getDocumentChanges()){
                    switch(dc.getType()){
                        case ADDED:
                            ...
                            data2 = new Board2(id,category,title,contents,userEmail,regDate,replyCnt,regDateModify,likeCnt);
                        ...
                        case MODIFIED:
                            ...
                            Board2 datacopy = new Board2(id1,category1,title1,contents1,userEmail1,regDate1,replyCnt1,regDateModify1,likeCnt1);
