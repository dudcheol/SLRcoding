...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBoardList.add(new Board(null,"축구","축구 할사람 여러분","내용입니다","android"));
        mBoardList.add(new Board(null,"축구","와~~토트넘 ", "내용입니다","server"));
        mBoardList.add(new Board(null,"축구","레알마드리드??","내용입니다","java"));
        mBoardList.add(new Board(null,"축구","히딩크 돌아와라","내용입니다","php"));
        mBoardList.add(new Board(null,"축구","박항서","내용입니다","python"));
        mBoardList.add(new Board(null,"축구","손흥민 잘한다..","내용입니다","server"));
        mBoardList.add(new Board(null,"축구","제 2의 박지성이냐","내용입니다","java"));
        mBoardList.add(new Board(null,"축구","축구는 뭐다?","내용입니다","php"));
        mBoardList.add(new Board(null,"축구","축구다!","내용입니다","python"));
