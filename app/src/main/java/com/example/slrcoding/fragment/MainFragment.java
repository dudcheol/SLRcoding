...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBoardList.add(new Board(null,"축구","레알마드리드??","내용입니다","java","10분전",0L,"10분전"));
        mBoardList.add(new Board(null,"축구","히딩크 돌아와라","내용입니다","php","10분전",0L,"10분전"));
        mBoardList.add(new Board(null,"축구","박항서","내용입니다","python","10분전",0L,"10분전"));
        mBoardList.add(new Board(null,"축구","손흥민 잘한다..","내용입니다","server","10분전",0L,"10분전"));
        mBoardList.add(new Board(null,"축구","제 2의 박지성이냐","내용입니다","java","10분전",0L,"10분전"));
